...
import (
	...
	"github.com/xmnservices/xmnsuite/applications/cryptocurrency/commands"
...
func generateConfigs() *cliapp.Command {
	return &cliapp.Command{
		Name:    "generate",
		Aliases: []string{"g"},
		Usage:   "Generates the encrypted configuration file (private keys) in order to interact with the XMN blockchains",
		Flags: []cliapp.Flag{
			cliapp.StringFlag{
				Name:  "pass",
				Value: "",
